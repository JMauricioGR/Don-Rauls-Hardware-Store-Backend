...
public class UpdateProductRoute {
    @Bean
    @RouterOperation(operation = @Operation(description = "Update product by id", operationId = "updateProduct", tags = "Product", parameters = { @Parameter(in = ParameterIn.PATH, name = "id", description = "Product Id") },
